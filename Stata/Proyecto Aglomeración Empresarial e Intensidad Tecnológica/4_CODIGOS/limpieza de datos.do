...
global dir1 "D:\STATA LIMPIO\1_INPUTS\ENCUESTA ECONOMICA ANUAL\2019\393-Modulo445"
*****************************************************************

cd "$intermedios"
import dbase "$dir1\a2014_CAP_01",clear
...
**MANUFACTURA D2 2014
global lugar "G:\Mi unidad\1_CURSOS\1_PUCP\2022-0\TEMAS DE ECONOMIA 1 (ECONOMIA URBANA)\PROYECTO FINAL - ECONOMIA URBANA\AVANCES\PARTE EMPIRICA\2_DATA\1_INPUTS\ENCUESTA ECONOMICA ANUAL\2019\393-Modulo455\a2014_s11_fD2"

import dbase "$lugar\a2014_s11_fD2_c00_1",clear
rename T07 ciiu
...
*****************************************************************
**PRODUCCION D2 2014
import dbase "$lugar\a2014_s11_fD2_c10AE_2",clear
...
import dbase "$lugar\a2014_s11_fD2_c10BE_2",clear
...
import dbase "$lugar\a2014_s11_fD2_c10CE_2",clear
...
egen produccion2014 = rowtotal(produccion2014A produccion2014B produccion2014C)
save produccionD2_2014,replace

////////////////////////
**TRABAJADORES D2 2014
import dbase "$lugar\a2014_s11_fD2_c11_1",clear
save trabajadoresD2_2014,replace


import dbase "$lugar\a2014_s11_fD2_c08BE_2",clear
...
*capital
import dbase "$lugar\a2014_s11_fD2_c05_1",clear
save capitalD2_2014,replace

import dbase "$lugar\a2014_s11_fD2_c05E_2",clear
...
**MATERIAL
*materia prima
import dbase "$lugar\a2014_s11_fD2_c09AE_2",clear
keep if CLAVE == "001" 
...
*envases
import dbase "$lugar\a2014_s11_fD2_c09BE_2",clear
keep if CLAVE == "001" 
...
*combustibles
import dbase "$lugar\a2014_s11_fD2_c09CE_2",clear
keep if CLAVE == "001" 
...
*repuestos
import dbase "$lugar\a2014_s11_fD2_c09DE_2",clear
keep if CLAVE == "001" 
...
*otros
import dbase "$lugar\a2014_s11_fD2_c09EE_2",clear
keep if CLAVE == "001" 
...
egen MaterialesTotalD2_2014 = rowtotal(MateriaPrimaD2_2014 EnvasesD2_2014 CombustiblesD2_2014 RepuestosD2_2014 OtrosInsumosD2_2014)
